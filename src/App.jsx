        ...
        <section className='flex items-center gap-16'>
          ...
          <div className='flex flex-col gap-5'>
            ...
            <ul className='h-197 w-577 flex gap-5 mt-8 flex-wrap animate-slideButtonsY'>
              ...
              <li className="animate-[buttonsVisible_3s_ease]"><a href="https://www.twitch.tv/netherim" target="_blank" rel="noopener noreferrer" className='flex justify-center items-center gap-2 h-14 w-40 border-3 border-[#423636] rounded-full font-fraunces text-custom font-light not-italic text-[#423636] leading-10 transition duration-300 hover:scale-110 hover:text-[#9361FF] hover:border-[#9361FF] group'>Twitch
                    <TwitchSvg className="h-6 w-5 fill-[#423636] duration-300 group-hover:fill-[#9361FF]"/>
                  </a>
              </li>
              <li className="animate-[buttonsVisible_3.5s_ease]"><a href="https://www.patreon.com/netherim" target="_blank" rel="noopener noreferrer" className='flex justify-center items-center gap-2 h-14 w-40 border-3 border-[#423636] rounded-full font-fraunces text-custom font-light not-italic text-[#423636] leading-10 transition duration-300 hover:scale-110 hover:text-[#FA7C34] hover:border-[#FA7C34] group'>Patreon
